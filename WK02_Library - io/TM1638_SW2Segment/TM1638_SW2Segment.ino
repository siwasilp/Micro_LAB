...
void loop() {
 ...
 tm.setLED(6, 0);
 tm.setLED(7, 0);
 if (SwInput == 0x01) tm.setLED(0, 1);
 if (SwInput == 0x02) tm.setLED(1, 1);
 if (SwInput == 0x04) tm.setLED(2, 1);
 if (SwInput == 0x08) tm.setLED(3, 1);
 if (SwInput == 0x10) tm.setLED(4, 1);
 if (SwInput == 0x20) tm.setLED(5, 1);
 if (SwInput == 0x40) tm.setLED(6, 1);
 if (SwInput == 0x80) tm.setLED(7, 1);
 delay(100);
}
